...
const eventsQueryByLocation2 = {
  query: `
    query {
      events (locationId: "Nordis1234567") {
        name
        id
        location {
          name
...
const eventsQueryByCreator = {
  query: `
    query {
      events (userId: "bbe42984-051b-4a01-b45d-b8d29c32200c") {
        name
        id
        createdBy {
          username
